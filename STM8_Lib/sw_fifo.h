/**
  ...
  declares and implementats a generic SW FIFO buffer, e.g. for sending and receiving via UART.
  Most action is done insede of interrupt service routines. For speed functions are declared 
